#' Modified astsa::arma.spec
#'
#' Same as astsa::arma.spec, but plot is optional
#'
#' @param ar vector of AR parameters
#' @param ma vector of MA parameters
#' @param var.noise variance of the noise
#' @param n.freq number of frequencies
#' @param frequency for seasonal models, adjusts the frequency scale
...
arma.spec2 <- function(ar=0, ma=0, var.noise=1, n.freq=500, plot = FALSE, 
  ...
  if (plot) astsa::tsplot(freq*xfreq, spec, xlab=Xlab, ylab=Ylab, main=main, ylim=ylim, ...)
